                    ...
                    <div class="jbcots">
                        <Row class="FLEX ALIGN_ITEM_CENTER">
                            <Col class="col00" style="width: 200px">
                                <Input :name="code" :model-value="rate" type="number" placeholder="점수입력" @update:modelValue="(e) => this.$emit('update:modelValue', e)" />
                            </Col>
                            <Col class="col00">
                            ...
                            <Col class="col00">
                                <RadioGroup>
                                    <Radio :name="`reqRdo_${code}`" :defaultChecked="required" label="필수" />
                                    <div style="width: 10px"></div>
                                    <Radio :name="`reqRdo_${code}`" :defaultChecked="!required" label="우대" />
                                </RadioGroup>
                            </Col>
                            <Col class="col00">
