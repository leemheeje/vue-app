            ...
            <div class="jbGlbNmLists show">
                ...
                <div class="jbGlbNmArea">
                    <div class="insrtNmArea">
                        <Input
                            :model-value="mzbyTitle"
                            placeholder="아래 모집분야명을 입력해주세요."
                            readonly
                        />
                        <div class="btnswa">
                            <button
                ...
                <div class="jbGlbTogArea">
                    ...
                    <RowLayout title="직급/직책" class="MT20">
                        <UiSelectedBox
                            ...
                            "
                            @click:afRightButtonBind="
                                isJcjgTooltipVisible = !isJcjgTooltipVisible
                            "
                        >
                            <template
                    ...
                    <RowLayout title="우대조건" class="MT20 MB40">
                        <UiSelectedBox
                            ...
                            "
                            @click:afRightButtonBind="
                                isWoodaeDialogVisible = !isWoodaeDialogVisible
                            "
                        >
                            <template
                                v-slot:UiSelectedBox-favorite
                        ...
                        <UiSelectedBoxDialog
                            ...
                            @click:dialogVisibleToggle="
                                (isVisible) =>
                                    (isWoodaeDialogVisible = isVisible)
                            "
